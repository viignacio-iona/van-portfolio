...
export default function FaultyTerminal({
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      if (mouseReact) {
        ...
        const currentSmoothMouse = { ...smoothMouseRef.current };
        const currentMouse = { ...mouseRef.current };
        
        currentSmoothMouse.x += (currentMouse.x - currentSmoothMouse.x) * dampingFactor;
        currentSmoothMouse.y += (currentMouse.y - currentSmoothMouse.y) * dampingFactor;
        
        smoothMouseRef.current = currentSmoothMouse;

        const mouseUniform = program.uniforms.uMouse.value as Float32Array;
        if (mouseUniform) {
          mouseUniform[0] = currentSmoothMouse.x;
          mouseUniform[1] = currentSmoothMouse.y;
        }
      }
  ...
  useEffect(() => {
    ...
    // Update uniforms with new prop values
